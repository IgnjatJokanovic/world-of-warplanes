 ...
 <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form action="../views/admin.php?page=newI" method="POST" enctype="multipart/form-data">
...
<tr>
    <td>Heading:</td>
    <td><input type="text" name="newIH"></td>
    <td>Text:</td>
    <td><input type="text" name="newIT"></td>
    <td>Image:</td>
    <td><input type="file" name="newII"></td>
...
<td><button type="submit" class="btn btn-primary" name="newIS">
Upload
...
if(isset($_POST['newIS'])){
    ...
    if(count($erors) == 0){
        ...
        if(move_uploaded_file($tmp, $newPath)){
            ...
            $stm->execute();
            $id = $con->lastInsertId();
            $query1 = "insert into content values('', :h1, :txt, :iId, 3)";
            ...
            $result = $stm1->execute();
            if($result){
                echo '<p class="text-success">News inserted successfully</p>';
