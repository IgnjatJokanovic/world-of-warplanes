                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="admin.php?page=galI">Insert</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin.php?page=typeUD">Update / Delete</a>
                                </li>
                                <li>
                                    <a href="admin.php?page=typeI">Insert</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="admin.php?page=newI">Insert</a>
                                </li>
